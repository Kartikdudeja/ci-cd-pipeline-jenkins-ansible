// Jenkinsfile for CI/CD Pipeline for JAVA Application
...
pipeline {
    ...
    stages {
        ...
        // deploying to Staging Server with Ansible
            ...
            steps {
                ansiblePlaybook([
                    ...
                    extraVars: [
                        ...
                        NEXUS_IP: "${NEXUS_IP}:${NEXUS_PORT}",
                        REPONAME: "${RELEASE_REPO}",
                        GROUP_ID: 'QA',
                        BUILD: "${env.BUILD_ID}",
                        TIME: "${env.BUILD_TIMESTAMP}",
                        ARTIFACT_ID: "${PROJECT_KEY}",
                        ARTIFACT_VERSION: "${PROJECT_KEY}-${env.BUILD_ID}-${env.BUILD_TIMESTAMP}.war"
                    ]
                ])
            }
        }
